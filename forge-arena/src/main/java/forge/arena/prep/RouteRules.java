...
/**
 * win-routes/6 feature classification — the code form of WIN-ROUTES.md §2.
 ...
 *
 * <p>win-routes/6: each rule carries a stable {@code ruleId} so the deck-level
...
public final class RouteRules {
    ...
    public static final String VERSION = "win-routes/6";
