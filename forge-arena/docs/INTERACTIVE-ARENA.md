...
75. **Autopass policy table (2026-09-07, BL-31).** `AutopassPolicy.decide(Stop)`
    ...
    opponent's COMBAT_BEGIN. Forge's own APINA still handles the truly-empty
    case first. Wedge threshold left at
